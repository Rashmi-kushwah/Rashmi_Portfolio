...
const Home = () => {
      ...
      <div className="homepage">
        ...
        <header className="header">
          <div className="left">
            ...
            <motion.h1
              initial={{ transform: 'translateY(-30px)', opacity: 0 }}  // Start from above and invisible
              animate={{ transform: 'translateY(0)', opacity: 1 }}  // Move to normal position and visible
  ...
  <div className="education">
    ...
    <p className="education-text">Fullstack Python develoepr Courese from Vision Infotech</p>
    ...
    <div className="skill-box">
       ...
       <section className="projects">
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-4">
          {["Recipe Manager", "Doctor Management System", "Random User Generator", "To-Do List"].map((project, index) => (
            <div key={index} className="bg-white text-black p-4 rounded-lg shadow-md">
              <h3 className="font-semibold">{project}</h3>
              <p>Project description goes here.</p>
              <div className="mt-4 flex justify-between">
                <button className="bg-blue-500 text-white px-3 py-1 rounded">GitHub</button>
                <button className="bg-green-500 text-white px-3 py-1 rounded">Live</button>
              </div>
            </div>
          ))}
        </div>
     ...
     {/* Certifications */}
<section className="text-center mb-12 bg-black">
  <h2 className="text-3xl font-bold text-white">Certifications</h2>

  <div className="mt-6 grid gap-6 md:grid-cols-4">
  {["Fullstack Python developer", "Django developer", "D.C.A ", "Git & GitHub"].map((cert, index) => (
    <div key={index} className="bg-white text-black p-4 rounded-lg shadow-md">
      <h3 className="certification_text">{cert}</h3> {/* Applying modern font style */}
...
{/* <section className="projects_container">
      <motion.div
        ...
        initial={{ opacity: 0, y: 50 }} // Neeche se upar
      ...
      >
        <div className="project_card">
          <h2>Weather App</h2>
          <p>A weather forecasting app built with ReactJS and a weather API.</p>
          <a href="https://github.com/Rashmi-kushwah/weather-app" target="_blank" rel="noopener noreferrer">View on GitHub</a>
        </div>

        <div className="project_card">
          <h2>E-Commerce Platform</h2>
          <p>Developed an e-commerce platform with admin panel and product management features using ReactJS, Django, and MySQL.</p>
          <a href="https://github.com/Rashmi-kushwah/e-commerce-platform" target="_blank" rel="noopener noreferrer">View on GitHub</a>
        </div>
      </motion.div>
    </section> */}
